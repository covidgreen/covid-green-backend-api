...
describe('register routes', () => {
  ...
  it('should return allow os and version to be passed to refresh', async () => {
    const token = {
      id: faker.lorem.word(),
      refresh: faker.lorem.word()
    }
  ...
  it.skip('should return an error when a refresh token is not provided', async () => {
    const mockInsert = jest.fn().mockResolvedValue({
      rowCount: 1
    })
