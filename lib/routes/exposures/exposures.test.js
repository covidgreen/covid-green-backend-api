...
describe('exposure routes', () => {
  ...
  it('should list all exposure files', async () => {
    ...
    const mockSelect = jest.fn().mockResolvedValue({ rows: results })
  ...
  it('should verify an upload code', async () => {
    ...
    mockQuery.mockResolvedValueOnce({
      rows: [{ createdAt: new Date(), onsetDate: new Date() }]
    })
  ...
  it('should upload exposures', async () => {
    ...
    const response = await server.inject({
      ...
      body: {
        ...
        exposures: [
          {
            keyData: faker.lorem.word(),
            rollingStartNumber,
            transmissionRiskLevel: faker.random.number(),
            rollingPeriod: faker.random.number()
          },
          {
            keyData: faker.lorem.word(),
            rollingStartNumber,
