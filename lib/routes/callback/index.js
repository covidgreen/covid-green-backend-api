 ...
 *
 * Not verified, but I assume the process that Contact Tracers use will clear the last_callback value
 * of the user's registration record thus allowing users to request another call should they need it.
 *
 ...
 *  429: An existing unfulfilled callback already exists for the user
 */
